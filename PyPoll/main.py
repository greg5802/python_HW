...
winner = []
winner.append(round((count_li/total_vote),2))
winner.append(round((count_correy/total_vote),2))
winner.append(round((count_khan/total_vote),2))
winner.append(round((count_otooley/total_vote),2))

print(f"Winner is Khan:",max(winner),"%")
